...
if __name__ == "__main__":
    ...
    check_eq("top_n_by_quantity 行数", len(top3) if top3 is not None else None, 3)
    check_eq("top_n_by_quantity 第一行是最大值",
              top3["quantity"].iloc[0] if top3 is not None else None, ref["quantity"].max())
